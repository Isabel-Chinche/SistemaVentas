    ...
    <div class="header-body">
      <div class="row align-items-center py-4">
        ...
        <div class="col-lg-6 col-5 text-right">
          <a href="<?php echo base_url(); ?>nuevo-cliente" class="btn btn-primary">Nuevo Cliente</a>
        </div>
      </div>
    </div>
  </div>
                ...
                <tbody class="list">
                  ...
                  <?php if(!empty($data)):?>
                    ...
                    <tr>
                      ...
                      <td class="text-right">
                        <div class="dropdown">              
                            <a class="btn btn-info" href="<?php echo base_url()."cliente/".$value->id; ?>">Editar</a>
                            <a class="btn btn-danger" href="<?php echo base_url()."cliente/delete/".$value->id; ?>">Elimnar</a>       
                        </div>
                      </td>
                    </tr>
                    <?php endforeach; ?>
