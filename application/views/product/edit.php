    ...
    <div class="row">
        ...
        <div class="col-xl-8 order-xl-1">
            <div class="card">
                ...
                <form action="<?php echo base_url();?>producto/update/<?php echo $id; ?>" method="POST">

                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label class="form-control-label">Código de barras</label>
                                <input type="text" name="barcode" class="form-control <?php echo form_error('barcode') ? 'is-invalid':''?>" placeholder="Valor del código de barras"  value="<?php echo form_error('barcode') ? set_value('barcode') : $barcode; ?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="stock" class="form-control <?php echo form_error('stock') ? 'is-invalid':''?>" placeholder="Stock del producto"  value="<?php echo form_error('stock') ? set_value('stock') : $stock; ?>">
