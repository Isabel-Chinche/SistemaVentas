    ...
    <div class="row">
        ...
        <div class="col-xl-8 order-xl-1">
            <div class="card">
                ...
                <form action="<?php echo base_url();?>reclamo/update/<?php echo $id; ?>" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control" rows="5" placeholder="Descripción del reclamo"><?php echo form_error('description') ? set_value('description') : $description; ?></textarea>
