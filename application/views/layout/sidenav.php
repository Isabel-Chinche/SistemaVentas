    ...
    <div class="scroll-wrapper scrollbar-inner">
      ...
      <div class="sidenav-header  align-items-center">
        <a class="navbar-brand" href="javascript:void(0)">
          <img src="<?php echo base_url(); ?>/assets/img/icono.jpeg" style="width: 100px; height: 500px" class="navbar-brand-img" alt="...">
        </a>
      </div>
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link nav-claim" href="<?php  echo base_url(); ?>reclamos">
                <i class="ni ni-folder-17 text-default"></i>
                <span class="nav-link-text">Reclamo</span>
              </a>
            </li>

            <li class="nav-item">
              <a class="nav-link nav-order" href="<?php  echo base_url(); ?>ordenes">
