    ...
    <div class="header-body">
      <div class="row align-items-center py-4">
        ...
        <div class="col-lg-6 col-5 text-right">
          <a href="<?php echo base_url(); ?>nuevo-categoria" class="btn btn-primary" >Nueva Categoría</a>
        </div>
      </div>
    </div>
  </div>
                  ...
                  <?php if(!empty($data)):?>
                    ...
                    <tr>
                      ...
                      <td class="text-right">
                        ...
                        <a class="btn btn-info" href="<?php echo base_url()."categoria/".$value->id; ?>">Editar</a>
                        <a class="btn btn-danger" href="<?php echo base_url()."categoria/delete/".$value->id; ?>">Eliminar</a>
