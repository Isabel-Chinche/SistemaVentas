    ...
    <div class="row">
        <div class="col-xl-8 order-xl-1">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo base_url();?>nuevo-categoria/save" method="POST">
                        <div class="form-group">
                            <label class="form-control-label" for="input-username">Nombre</label>
                            <input type="text" name="name" class="form-control <?php echo form_error('name') ? 'is-invalid':''?>" placeholder="Nombre de la categoría"  value="<?php echo set_value('name'); ?>">
